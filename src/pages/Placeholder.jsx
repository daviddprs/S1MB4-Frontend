...
const PAGE_NAMES = {
  ...
  '/ejsc': 'EJSC',
  '/sakip-rb': 'SAKIP-RB',
  '/profil/visi-misi':             'Visi Dan Misi',
  '/profil/kedudukan-alamat':      'Kedudukan dan Alamat',
  '/profil/struktur-organisasi':   'Struktur Organisasi',
  '/profil/wilayah-kerja':         'Wilayah Kerja',
  '/profil/pejabat-struktural':    'Pejabat Struktural',
